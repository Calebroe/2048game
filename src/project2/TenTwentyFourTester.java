...
public class TenTwentyFourTester {
	...
	@Test()
	public void basicResizeBoard(){
		NumberGameArrayList s = new NumberGameArrayList();
		s.resizeBoard(10, 10, 16);
		assertTrue(s.getHeight() == 10);
		assertTrue(s.getWidth() == 10);
		assertTrue(s.getWinning_value() == 16);
	}
	@AfterClass
